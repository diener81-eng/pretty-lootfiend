...
export const InventoryCategory = ({
  ...
  return <div className="glass rounded-lg overflow-hidden">
      <button onClick={() => setIsOpen(!isOpen)} className="w-full px-4 py-3 flex items-center justify-between transition-colors bg-card border border-solid border-muted">
